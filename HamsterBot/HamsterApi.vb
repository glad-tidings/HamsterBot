...
Public Class HamsterApi
    ...
    Public Sub New(ByVal bearerAuth As String, ByVal bearerIndex As Integer)
        ...
        client.DefaultRequestHeaders.Add("authorization", $"Bearer {bearerAuth}")
        ...
        client.DefaultRequestHeaders.Add("User-Agent", userAgents(bearerIndex))
        client.DefaultRequestHeaders.Add("accept", "application/json")
        client.DefaultRequestHeaders.Add("sec-ch-ua-mobile", "?0")
        'client.DefaultRequestHeaders.Add("sec-ch-ua-platform", """Windows""")
    End Sub

    Public Async Function HAPIGet(requestUri As String) As Task(Of HttpResponseMessage)
        Try
    ...
    Public Async Function HAPIPost(requestUri As String, content As HttpContent) As Task(Of HttpResponseMessage)
        Try
